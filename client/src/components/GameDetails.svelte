        ...
        <div class="p-6">
            ...
            <div class="mt-8">
                <button 
                    ...
                    aria-pressed={thisGameHasMyPatronage ? 'true' : 'false'}
                    aria-label={thisGameHasMyPatronage ? 'Remove your support for this game' : 'Add your support to help fund this game'}>
